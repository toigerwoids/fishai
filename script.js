...
function nextStep() {
  ...
  function createLogoCircle() {
    ...
    logoCircle.html(
      '<img src="https://i.ibb.co/NdYXjt2q/Untitled-design-2025-02-20-T220928-715.png" alt="Logo" style="width: 90%; height: 90%; border-radius: 50%;" />'
    );
  ...
  async function fetchMarketCap() {
    const tokenAddress = "7nwdtHmf4WLtNf1hTBVZJk5THKPtuUrcSoZoZu2Apump"; // Replace with your token address
  ...
  function createInfoDisplay() {
    ...
    const fullAddress = "7nwdtHmf4WLtNf1hTBVZJk5THKPtuUrcSoZoZu2Apump";
